...
use crate::util::F32Color;

///Defines a General Material to use with some kind of mesh.
///It will be converted from an ambient, diffuse, and specular values, into
/// the albedo for a [CpuMaterial](three-d::CpuMaterial)
#[derive(Default)]
...
const ORIGINAL_MATERIALS: [MaterialInfo; 16] = [
    MaterialInfo::new(
        //EMERALD
...
// const ORIGINAL_MATERIALS: [MaterialInfo; 16] = Default::default();

//The original MATERIAL.C code that we need to base and port:
// /******************************Module*Header*******************************\
...
//The shader code to base the rendering off of
