/**
 * @file PipeMain.cpp
 * @author Alex "FaceFTW" Westerman(you@domain.com)
 * @brief 
 * @version 0.1
 * @date 2022-03-15
 * 
...
/* This is primarily copied from SSPIPES.C atm
* Need to weed out the COM calls and all the other stuff
*
*/
...
#include <sys/timeb.h>
#include <time.h>
//TODO remove any relevant windows bindings 
//#include <windows.h>

#include "include/pipe_main.h"

//TODO move dialog option stuff to CLI input parsing
//#include "dialog.h"
